...
import { AIGateMessageUnion, AssistantService } from "./helport-assistant";
import "./App.css";

const ORIGIN = "https://dev-fwd.helport.ai";

const Assistant = (window as any).helportAssistant.default;
            ...
            <>
              <div className="actions">
                ...
                <button
                  className="api"
                  onClick={() => {
                    assistant.current.send({ type: "onTalkBegin" });
                  }}
                >
                  onTalkBegin
                </button>
